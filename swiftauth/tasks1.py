...
@shared_task
def send_bulk_sms_task(greetings,message,companu_instance_name):
    ...
    save_email = Messagescontent(id=unique_badge_id,subject=greetings,message=message,sent=True,error_message="None",type="Sms")
    save_email.save() 
