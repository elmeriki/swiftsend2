...
@shared_task
def schedule_bulk_emails_task(subject, message,introtext,greetings,companu_instance_name):
    ...
    save_email = Messagescontent(id=unique_badge_id,subject=subject,message=message,sent=True,error_message="None",type="Semail")
    save_email.save() 
    ...
    for user in users:
        try:
            ...
            'Messages': [
                ...
                "HTMLPart":
                f"""
                <p><a href='https://www.muketegroup.co.za'><img src="https://www.clipartmax.com/png/middle/270-2702992_superb-swimming-pool-company-logo-design-pools-logo.png" height='60px'></a> <br><br> <strong>{greetings} {user.first_name} </strong> <br><br> 
                {introtext}.<br>
                <br>
                {message}.<br>
                <br>
